...
public class AssetMenu {
	...
	public static Asset takeAssetInput() {
        ...
        while(categoryIdSelected == false) {
            ...
            CategoryMenu.switchCategoryMenu(2);
            ...
            try {
    			...
    			CategoryMenu.switchCategoryMenu(1);
    		} finally {
	...
	public static void displayAssetMenu() {
	    while (true) {
	        ...
	        System.out.println("1. Add an asset");//admin
	        System.out.println("2. Get all assets");//admin
	        System.out.println("3. Find an asset by ID");//admin
	        System.out.println("4. List available assets");//user
